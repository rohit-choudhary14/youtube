<%-- 
    Document   : thumbnale_upload
    Created on : 25 Feb, 2022, 1:12:33 AM
    Author     : rohit
--%>
            ...
            <div class="market-updates">
                ...
                <div class="col-md-6 market-update-gd">
                    <div class="login-form">
                            ...
                            <form method="post" ACTION="thumbnale_process.jsp?code=<%=code%>" name="uploadForm" ENCTYPE='multipart/form-data'>

                       
                        <div class="form-group">
                            <label class="text-center"><h4>Upload Thumbnail:</h4></label>
