<%-- 
    Document   : deleted_vedios
    Created on : 10 Mar, 2022, 2:53:09 AM
    Author     : rohit
--%>
...
<BODY>
    <section id="container">
            ...
            <section id="main-content"style="background-color:#FAF9F9;margin-left:195px;height:650px">
 ...
 <div class="col-sm-12  card" style="margin-top:2%">
                     ...
                     <%
                                  ...
                                  try{ 
                                       ...
                                       Statement st1=cn.createStatement();
                                       Statement st2=cn.createStatement();
                                       ResultSet rs=st1.executeQuery("select * from vedio where email='"+email+"' AND status='"+0+"' ");
                                 ...
                                 %>
                                  <div class="row" style="margin-top:1%">
                                    ...
                                    <div class="col-sm-2" style="margin-top:3%">
                                       <a href="recover_vedio.jsp?code=<%=code%>"><i class="fa fa-undo" style="color:red;cursor:pointer;">&nbsp;undo</i></a>
                                    </div>
                                </div>
                                 
                                     <!---  <div class="col-sm-12" >
                                        
                                         <TABLE class="table table-bordered w3 card "height="170px">  <tr><td style="color:black">
                                                    <strong> Vedio</strong></td><td width="130px" style="color:black"><strong>Title</strong></td><td style="color:black" width="130px"><strong>publish date</strong></td><td width="130px" style="color:black"><b>views</b></td><td width="130px" style="color:black"><strong>like</STRONG></td><td width="130px" style="color:black"><strong>comments</STRONG></td></tr>
                                             <tr><td  width="250px" >
                                                    
                                             <input type="checkbox" name="delete" class="selected" id="down" required><center><video  width="230"  
                                                            height="150" 
                                                           controls poster=
                                                            "thumbnale/<%=code%>.jpg"> 
                                                                    <source src=
                                                     ...
                                                     accesskey=""  type="video/mp4">
                                                      ...
                                                      <td style="color:black"><strong><%=title%></strong></td> <td style="color:black"><%=date%></td><td style="color:black">100</td><td style="color:black"> 25</td><td style="color:black">9</td></tr>
                                      <tr><td>
                                             -->        
