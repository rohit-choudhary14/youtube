<%-- 
    Document   : vedio_process_upload_final
    Created on : 27 Feb, 2022, 4:25:40 AM
    Author     : rohit
--%>
...
<section id="container">
	...
	<section class="wrapper">
		...
		<div class="market-updates">
                   ...
                   <form method="post" ACTION="final_vedio_process.jsp?code=<%=code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
                     
          
              <div class="form-group">
             <label class="text-center"><h4>Upload Vedio:</h4></label>
