<%--  
    Document   : dashbord
    Created on : 23 Feb, 2022, 3:24:32 PM
    Author     : rohit
--%>
		...
		<div class="market-updates">
                    <%
                               try{ 
                                    ...
                                    Statement st2 = cn.createStatement();
                                    ResultSet rs2=st2.executeQuery("select * from channel where email='"+email+"'");
                                   if(rs2.next()){
                           ...
                           %>
				       <div class="col-md-4 market-update-gd"></div>
					   <div class="col-md-4 market-update-gd">
					     
					     
                                                     <form method="post="action="create_channel.jsp">
