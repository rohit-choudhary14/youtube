<%--   
    Document   : vedio_play_edit_secreen
    Created on : 1 Mar, 2022, 11:43:19 PM
    Author     : rohit
--%>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="your_channel.jsp">
                                     ...
                                     <div class="col-sm-8" style="margin-top:20px">
                                        <%
                                                try {
                                                    ...
                                                    ResultSet rs = st.executeQuery("select * from vedio where code='"+vedio_code+"'");
                                                     ...
                                                     if(rs.next()) {
                                                        ...
                                                        %>
                                                 <table>
                                                          <tr><td colspan="4">  <video   width="650" 
                                                                   height="350" 
                                                                   controls poster=
                                            ...
                                            <tr><td colspan="4"> <b><%=vedio_title%></b></td><td></td></tr>
                                             <tr   class="table table-bordereless"><td></td> </tr>
                                            <tr><td colspan="4"><i class="fa fa-thumbs-up" style="font-size:20px"></i>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <i class="fa fa-thumbs-down" style="font-size:20px">DISLIKE</i>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <i class="fa fa-share"style="font-size:20px">SHARE</i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:20px;color:black" >publish date:&nbsp;<%=vedio_date%></span></td></tr>
                                                
                                                
                                            <tr class="table table-bordereless"><td colspan="4">
                                                   ...
                                                   <div class="row">
                                                    ...
                                                    <span style="float:right"><button class="btn btn-primary">Analytics</button></span>
                                            
                                               </td></tr>
                                            <tr   class="table table-bordereless"><td><i class="fa fa-angle-down" id="down" style="font-size:24px"></i></td></tr>
                                            <tr> <td colspan="2" id="description" class="link"><%=vedio_description%></td></tr>
                                             <tr   class="table table-bordereless"><td style="font-size:24px"><b>Comments</b></td> </tr>            
                                       ...
                                       <div class="col-sm-4" style="margin-top:20px">   
                                            <%
                                                    ...
                                                    ResultSet rs1 = st1.executeQuery("select * from vedio where email='"+email+"'");
                                                    while (rs1.next()) {
                                            ...
                                            <div class="row">
                                                ...
                                                <a href="vedio_play_edit_secreen.jsp?code=<%=code%>&title= <%=title%>" style="color:black">      
                                                    <video   width="100%"
                                                                   poster=
                                                                    "thumbnale/<%=code%>.jpg" class="img-responsive">
                                                                  <source src=
                                                        ...
                                                        <%=title%>
                                                      <!-- <img src="channel_images/<%=channel_code%>.jpg" width="30px" height="30px" class="img-circle">&nbsp;&nbsp;
                                                                <%=channel_name%> <i class="fa fa-check-circle"></i>&nbsp;-->
